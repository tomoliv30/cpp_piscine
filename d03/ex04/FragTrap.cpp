...
/*   Updated: 2021/03/26 11:16:33 by totartar      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << getAttributeString(TYPE) << " named " << getAttributeString(NAME) << " performs overidden FragTrap meleeAttack on " << target << " causing " << getAttributeUint(MELE_ATTACK_DAMAGE) << " points damage!" << std::endl;
}

void				FragTrap::rangedAttack(std::string const & target)
{
	std::cout << getAttributeString(TYPE) << " named " << getAttributeString(NAME) << " performs overidden Fragtrap ranged attack on " << target << " causing " << getAttributeUint(RANGED_ATTACK_DAMAGE) << " points damage!" << std::endl;
}
