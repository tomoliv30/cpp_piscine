...
/*   Updated: 2021/03/26 11:08:43 by totartar      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << getAttributeString(TYPE) << " named " << getAttributeString(NAME) << " performs overidden NinjaTrap meleeAttack on " << target << " causing " << getAttributeUint(MELE_ATTACK_DAMAGE) << " points damage!" << std::endl;
}

void				NinjaTrap::rangedAttack(std::string const & target)
{
	std::cout << getAttributeString(TYPE) << " named " << getAttributeString(NAME) << " performs overidden NinjaTrap ranged attack on " << target << " causing " << getAttributeUint(RANGED_ATTACK_DAMAGE) << " points damage!" << std::endl;
}
