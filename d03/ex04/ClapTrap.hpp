...
/*   Updated: 2021/03/26 11:16:25 by totartar      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
enum	e_attribute_value
{
	...
	SUPERTRAP_HIT_POINTS = FRAGTRAP_HIT_POINTS,
	SUPERTRAP_MAX_HIT_POINTS = FRAGTRAP_MAX_HIT_POINTS,
	SUPERTRAP_ENERGY_POINTS = NINJATRAP_ENERGY_POINTS,
	SUPERTRAP_MAX_ENERGY_POINTS = NINJATRAP_MAX_ENERGY_POINTS,
	SUPERTRAP_LEVEL = 1,
	SUPERTRAP_MELE_ATTACK_DAMAGE = NINJATRAP_MELE_ATTACK_DAMAGE,
	SUPERTRAP_RANGED_ATTACK_DAMAGE = FRAGTRAP_RANGED_ATTACK_DAMAGE,
	SUPERTRAP_ARMOR_DAMAGE_REDUCTION = FRAGTRAP_ARMOR_DAMAGE_REDUCTION
};
