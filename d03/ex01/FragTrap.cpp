...
/*   Updated: 2021/03/26 10:58:59 by totartar      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "FragTrap " << _name << " attacks " << target << " at range, causing " << _rangedAttackDamage << " points damage!" << std::endl;
}

void		FragTrap::meleeAttack(std::string const & target)
{
	std::cout << "FragTrap " << _name << " attacks " << target << " at melee, causing " << _meleeAttackDamage << " points damage!" << std::endl;
}
